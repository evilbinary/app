...
{
    // Load images
    m_surfaces[T_SURFACE_BG] = SDL_utils::loadImage("res/home.jpg");
    m_surfaces[T_SURFACE_FILE] = SDL_utils::loadImage("res/file-text.png");
    ...
    // Load font
    m_font = SDL_utils::loadFont("font/font.ttf", 8);
}
